...
- Available as CLI tool or REST API
...
```
python k8s_claude_agent.py
```

With this version:
- Type natural language questions about your Kubernetes cluster
- The agent will suggest kubectl commands but won't run them automatically
- To run a command, type `run:` followed by the kubectl command
